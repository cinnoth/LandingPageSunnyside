...
export const TestimonialContainer = () => {
  return (
    <section className="bg-white pt-16">
      <h2 className="font-Fraunces text-center uppercase mb-16 text-Grayish-blue">Client testimonials</h2>
      <div className="lg:flex lg:w-[900px] lg:mx-auto xl:w-[1010px]">
        <Testimonio
          img={emilyPhoto}
